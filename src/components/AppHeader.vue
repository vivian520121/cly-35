...
import { Plus, Trash2, HelpCircle, StickyNote } from 'lucide-vue-next'
...
<template>
  <header class="fixed top-0 left-0 right-0 z-50 h-14 bg-white/80 backdrop-blur-md border-b border-gray-200/50 shadow-sm">
